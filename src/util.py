...
class EarlyStopping:
    ...
    def __init__(self, patience=10, verbose=False, delta=0, ckpt_dir='./checkpoint', trace_func=print):
        """
        Args:
...
class opts():
    def __init__(self):
        ...
        self.parser.add_argument("--loop", default="stroll", choices=["stroll", "train_test", "test", "evaluate"], type=str, dest="loop")
